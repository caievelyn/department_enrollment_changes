...
all %>%
  ...
  # positive or negative. This is important so we can color the two differently
  # in our graphic.
  ...
  # variable on the y-axis, with the bar colors corresponding to the type of
  # change as mentioned earlier
  
  ggplot(mapping = aes(x = department, y = change, fill = type_of_change)) +
  
  # Add the bars and remove the legend since the colors are self-explanatory
  ...
  # Use the Set1 palette from the RColorBrewer palettes to color the bars, with
  # strongly contrasting colors again for ease of reading
  ...
  # Change the x- and y- axis labels so they are more professional and explain the change in numbers better than just "change" (for example)
